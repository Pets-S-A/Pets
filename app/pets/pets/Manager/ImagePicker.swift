...
class ImagePickerManager: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func pickImage(_ viewController: UIViewController, _ callback: @escaping ((UIImage) -> ())) {
        ...
        let cameraAction = UIAlertAction(title: NSLocalizedString("Câmera", comment: ""), style: .default){
            UIAlertAction in
            self.openCamera()
        }
        
        let gallaryAction = UIAlertAction(title: NSLocalizedString("Galeria", comment: ""), style: .default){
            UIAlertAction in
            self.openGallery()
        }
